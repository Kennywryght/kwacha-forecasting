    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
      ...
      {data && !loading && data.data?.length > 0 && (
        <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl p-5 backdrop-blur">
          <h3 className="text-sm font-semibold text-slate-300 uppercase tracking-wider mb-4">Rate chart</h3>
          <ResponsiveContainer width="100%" height={350}>
            <AreaChart data={data.data}>
              ...
              <Tooltip contentStyle={{ backgroundColor: "#1e293b", borderRadius: 8, border: 'none', color: '#e2e8f0', fontSize: 12 }}
