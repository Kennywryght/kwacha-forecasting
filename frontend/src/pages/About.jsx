  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12 space-y-10">
      ...
      <div className="text-center">
        <h1 className="font-display text-4xl font-semibold text-stone-100 mb-4">About KwachaCast</h1>
        ...
        <div className="rate-wave-divider w-40 mx-auto mt-6" />
      </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="font-display text-2xl font-semibold text-stone-100">Problem & solution</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-terracotta-500/10 border border-terracotta-500/20 rounded-xl p-5">
            <h3 className="text-terracotta-400 font-semibold mb-2 text-sm uppercase tracking-wider">The problem</h3>
          ...
          <div className="bg-gold-500/10 border border-gold-500/20 rounded-xl p-5">
            <h3 className="text-gold-400 font-semibold mb-2 text-sm uppercase tracking-wider">Our solution</h3>
            <p className="text-stone-300 text-sm leading-relaxed">
      ...
      <section>
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="font-display text-2xl font-semibold text-stone-100">How it works</h2>
        </div>
        <div className="bg-stone-900/60 border border-stone-700/60 rounded-xl p-6 space-y-4">
          {[
            ...
            <div key={item.step} className="flex items-start gap-3">
              <span className="font-data bg-gold-400 text-ink-950 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
                {item.step}
              </span>
              <div>
                <h3 className="font-semibold text-stone-100 text-sm">{item.title}</h3>
      ...
      <section>
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="font-display text-2xl font-semibold text-stone-100">Models & technology</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-stone-900/60 border border-stone-700/60 rounded-xl p-5">
            <h3 className="text-stone-100 font-semibold text-sm mb-3">Forecasting models</h3>
            <div className="space-y-2 text-xs">
              {[
                ...
                <div key={m.name} className="flex items-start gap-2">
                  <span className="text-gold-400 font-mono text-xs min-w-[80px]">{m.name}</span>
                  <span className="text-stone-400">{m.desc}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="bg-stone-900/60 border border-stone-700/60 rounded-xl p-5">
            <h3 className="text-stone-100 font-semibold text-sm mb-3">Technology stack</h3>
            <div className="space-y-2 text-xs">
              {[
                ...
                <div key={t.cat} className="flex items-start gap-2">
                  ...
                  <span className="text-stone-400">{t.tech}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="font-display text-2xl font-semibold text-stone-100">Model performance</h2>
        </div>
        <div className="bg-stone-900/60 border border-stone-700/60 rounded-xl p-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
            {[
              ...
              <div key={m.label} className="bg-stone-700/40 rounded-lg p-3">
                <p className="font-data text-2xl font-semibold text-gold-400">{m.value}</p>
                <p className="text-stone-100 text-xs font-medium mt-1">{m.label}</p>
      ...
      <section>
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="font-display text-2xl font-semibold text-stone-100">Key features</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={f.title} className="bg-stone-900/60 border border-stone-700/60 rounded-xl p-4">
              <h3 className="text-stone-100 font-semibold text-sm mb-1">{f.title}</h3>
